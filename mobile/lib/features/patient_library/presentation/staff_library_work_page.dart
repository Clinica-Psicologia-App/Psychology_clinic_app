...
// ── Sheet de indicação ───────────────────────────────────────────────────────
class _IndicateSheet extends ConsumerStatefulWidget {
  const _IndicateSheet({required this.patientId, required this.work});
  final String patientId;
  final LibraryWorkFull work;

  @override
  ConsumerState<_IndicateSheet> createState() => _IndicateSheetState();
}

class _IndicateSheetState extends ConsumerState<_IndicateSheet> {
