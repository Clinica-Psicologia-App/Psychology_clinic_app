-- RPC que agrega alertas clínicos do psicólogo logado.
--
-- Retorna até 3 itens por categoria:
--   missing_checkins      pacientes com app sem check-in há ≥ 7 dias
--   expiring_invitations  convites pendentes que expiram em ≤ 3 dias
--   stale_questionnaires  questionários em rascunho há ≥ 7 dias sem conclusão
--
-- SECURITY DEFINER: roda como owner (bypassa RLS), mas aplica o filtro
-- responsible_psychologist_id = auth.uid() em todas as subqueries.
